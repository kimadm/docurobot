# Generated by Django 6.0.2 on 2026-02-26 12:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docrobot_url', models.CharField(default='https://edi-api.docrobot.kz', max_length=255, verbose_name='URL Docrobot API')),
                ('docrobot_username', models.CharField(blank=True, max_length=100, verbose_name='Логин Docrobot')),
                ('docrobot_password', models.CharField(blank=True, max_length=255, verbose_name='Пароль Docrobot')),
                ('docrobot_poll_interval', models.IntegerField(default=60, verbose_name='Интервал опроса (сек)')),
                ('docrobot_gln', models.CharField(blank=True, default='', max_length=13, verbose_name='GLN компании')),
                ('cleanup_days', models.IntegerField(default=90, verbose_name='Хранить документы (дней, 0 = не удалять)')),
                ('onec_url', models.CharField(default='http://localhost/hs/docrobot/orders', max_length=255, verbose_name='URL 1С HTTP-сервиса')),
                ('onec_username', models.CharField(blank=True, max_length=100, verbose_name='Логин 1С')),
                ('onec_password', models.CharField(blank=True, max_length=255, verbose_name='Пароль 1С')),
                ('onec_timeout', models.IntegerField(default=30, verbose_name='Таймаут 1С (сек)')),
                ('telegram_token', models.CharField(blank=True, max_length=255, verbose_name='Telegram Bot Token')),
                ('telegram_chat_id', models.CharField(blank=True, max_length=100, verbose_name='Telegram Chat ID')),
                ('docrobot_status', models.CharField(default='unknown', max_length=20, verbose_name='Статус Docrobot')),
                ('onec_status', models.CharField(default='unknown', max_length=20, verbose_name='Статус 1С')),
                ('docrobot_tested_at', models.DateTimeField(blank=True, null=True, verbose_name='Проверен Docrobot')),
                ('onec_tested_at', models.DateTimeField(blank=True, null=True, verbose_name='Проверен 1С')),
